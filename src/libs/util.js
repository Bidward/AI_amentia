...
export const TOKEN_KEY = 'SESSION1'// 仅前端用作是否登录的状态位
...
export const getToken = () => {
  ...
  // Todo,等后端解决了cookie写在根路径，httpOnly false，就可以直接拿后端设置的cookie
...
const showThisMenuEle = (item, access) => {
  ...
  } else return true // 没有access属性的表明无权限限制
}
