    ...
    <div>
        <div class="searchbox">
            ...
            <TableHeaderSetting
                ...
                key="productToContactTabelHeader"
                localKey="productToContactTabelHeader"
        ...
        <OpLogs v-if="!isFullScreen" :task-logs="productLog" @click.native="getLog" style="padding-bottom: 0; margin-top: 0"></OpLogs>
    </div>
</template>
<script>
import mixins from './mixins'
export default {
  name: 'productToContact',
  mixins: [mixins],
  props: {
    isFullScreen: {
      type: Boolean,
