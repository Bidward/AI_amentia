  ...
  <div class="detailContent">
      <Row  class="rowPadding">
        <Col span="16" offset="4">
          ...
          <Table border :columns="linkHeader" :data="linkContent">
    ...
    <Modal :mask-closable="false" id="addNotice" :loading="loading" v-model="showLink" :title="modalTitle" class="addlink" @on-ok="saveToTable">
