...
<div class="detailContent">
    ...
    <Modal :mask-closable="false"  :loading="loading" id="addContract" @on-ok="saveToTable('addContract')" v-model="addContractModal" :title="modalTitle" width="800px">
        ...
        <Form ref="addContract" :model="addContract" :rules="ruleAddContract">
            <Row class="rowPadding" style="margin-bottom:0px">
                ...
                <FormItem prop="contactName">
                    <Input v-model="addContract.contactName" placeholder="请输入联系人" clearable filterable maxlength="20" show-word-limit></Input>
                </FormItem>
                </Col>
                ...
                <Col span="6">
                    <FormItem prop="contactNumber">
                        <Input v-model="addContract.contactNumber" placeholder="请输入联系电话" clearable filterable maxlength="50" show-word-limit></Input>
                    </FormItem>
                </Col>
            </Row>
        </Form>
        ...
        <Row class="rowPadding">
            ...
            <Col span="6">
            <Input v-model="addContract.contactWechat" placeholder="请输入微信" clearable filterable maxlength="50" show-word-limit></Input>
            </Col>
        </Row>
        ...
        <Row class="rowPadding">
            ...
            <Col span="6">
            <Input v-model="addContract.contactEmail" placeholder="请输入邮箱" clearable filterable maxlength="50" show-word-limit></Input>
            </Col>
            ...
            <Col span="6">
            <Input v-model="addContract.contactPosition" placeholder="请输入公司职位" clearable filterable maxlength="50" show-word-limit></Input>
            </Col>
        </Row>
    </Modal>
  ...
  data () {
    return {
      ...
      contractHeader: [{
        ...
        // console.log(params)
        //   return(
        //   <span class={(this.flag ? 'black':'red')}>{params.row.contactName}</span>
        //   )
        // }
      }, {
        title: '联系电话',
