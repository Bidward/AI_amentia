...
<!--新增收款合同 我方拟定-->
    <div class="cloudCooper">
        ...
        <div class="detailContent">
            ...
            <Row class="rowPadding" v-if="isPerson">
                ...
                <Col span="5">
                    ...
                    <Cascader :data="addIncome.busicityListData" v-model="addIncome.busicityList" @on-visible-change="getBusicity"></Cascader>
                </Col>
                <Col span="3"  class="title">
                详细地址：
                </Col>
        ...
        <div class="detailContent">
            ...
            <!--通知人弹窗-->
            <Modal  :mask-closable="false" id="addNotice" v-model="showEntry" title="通知人" @on-ok="addTwoEntry=false">
                <Select v-model="addIncome.twoEntryId" filterable  :label-in-value="true" @on-change="getEntryName">
             ...
             <!--抄送人弹窗-->
            <Modal :mask-closable="false" id="addNotice" v-model="showNotice" title="抄送人">
  ...
  data () {
    return {
      ...
      ruleAddIncome: {
        ...
        wecompanybank: [{ required: true, message: '公司账号是必填项哦', trigger: 'blur' }],
