...
<div class="cloudCooper">
    <Tabs value="1" tab="outTable" :animated="false">
        <TabPane label="渠道公司" name="1">
            ...
            <br>
            <!--合同库-->
            <payContractComponent></payContractComponent>
            ...
            <Modal :mask-closable="false" id="addNotice" v-model="showEntry" title="通知人" @on-ok="addTwoEntry=false">
                <Select v-model="twoEntryId" filterable :label-in-value="true" @on-change="getEntryName">
...
import payContractComponent from '../component/product/payContractComponent'
import {
  baseUrl
} from '@/api/base.js'
export default {
