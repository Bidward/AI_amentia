        ...
        <Row class="rowPadding">
            ...
            <Col span="5">
                ...
                >
                    ...
                    <div style=" width: 90px;float: left;position: relative">
                        <Icon v-if="addIncome.enclosurePic[index].tag==='new'" type="ios-close-circle-outline" style="position: absolute;left: 70px;top: 4px;color: red;cursor: pointer;" @click="deleteImg(index)"/>
...
export default {
  ...
  methods: {
    ...
    saveSupplement () {
      let sendData = {
        id: this.$route.query.id, // 这条数据ID
        enclosure: this.enclosureWord, // 附件 []
        enclosurePic: this.addIncome.enclosurePic, // 图片[]
