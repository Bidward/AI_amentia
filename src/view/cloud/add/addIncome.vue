    ...
    <Form ref="addIncome" :model="addIncome" :rules="ruleAddIncome">
        ...
        <div class="detailContent">
            ...
            <Row class="rowPadding" v-if="isPerson">
                ...
                <FormItem prop="contractPartycompany">
                    <Select v-model="addIncome.contractPartycompany" clearable filterable @on-change="choseCompanyType">
                        <Option v-for="item  in addIncome.contractPartycompanyList" :value="item.id" :key="item.id" :label="item.name">{{item.name}}</Option>
                    </Select>
                </FormItem>
                </Col>
                <Col span="3" class="title">
            ...
            <Row class="rowPadding" v-if="isPerson">
                ...
                <Col span="5">
                    ...
                    <Cascader :data="addIncome.busicityListData" change-on-select :load-data="loadData" v-model="addIncome.busicityList" @on-visible-change="getBusicity"></Cascader>
                </Col>
                <Col span="3" class="title">
                详细地址：
                </Col>
        ...
        <div class="detailContent" v-if="isTwo">
            ...
            <Row class="rowPadding">
                ...
                <Col span="5">
                <Upload class="bzUpload" :max-size="20480" multiple name="fileData" :on-success="(value)=> uploadFileSuccess(value)" :on-exceeded-size="uploadFileError" :action="staticUrl+'/index.php'">
...
export default {
  ...
  methods: {
      ...
      if (this.$route.query.type === 'tbc') {
        ...
        this.$axios({
          ...
          if (res.data.code === 10000) {
            ...
            this.addIncome.twoEntryName = res.data.content.twoEntryName
            // 对比信息
    ...
    uploadPhotoSuccess (response, file, fileList) {
      ...
      console.log(this.addIncome.enclosurePic)
    },
    // 附件上传失败
    uploadError (file) {
    ...
    getEchoData () {
      ...
      this.$axios({
        ...
        if (res.data.code === 10000) {
          ...
          _c.money = _p.money
          _c.remark = _p.remark
          _c.twoEntryId = _p.twoEntryId // 通知人ID
          _c.copier = _p.copier
