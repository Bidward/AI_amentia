    ...
    <Row class="rowPadding">
        ...
        <Table border id="contractTable" :columns="contractHeader" :data="contractData">
            <template slot-scope="{ row, index }" slot="action">
                <Button v-if="$route.name === 'editProduct' || $route.name === 'editChannel' || $route.name === 'twoEditProduct'" type="primary" size="small" style="margin-right: 5px" @click="edit(row,index)">编辑</Button>
