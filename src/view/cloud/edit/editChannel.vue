    ...
    <Tabs value="1" tab="outTable" :animated="false">
        <TabPane label="渠道公司" name="1">
            ...
            <div class="detailContent">
                ...
                <!--19.11.5 暂时隐藏二级标签-->
                <Row class="rowPadding" v-for="(addItem,index) in mainBusi.busiTimes" :key="addItem.id">
                    <Col span="3" offset="3" class="title">
                    一级标签：
                    </Col>
                    <Col span="5">
            ...
            <div class="detailContent">
                ...
                <div class="detailContent">
                    <Row v-for="(addItem,index) in mainBusi.reverseLabel" :key="addItem.id" class="rowPadding">
                    <Col span="3"  offset="3" class="title">
                      一级标签 :
                    </Col>
                    <Col span="5">
                ...
                <Row class="rowPadding" >
                    <Col span="17" offset="4">
                        ...
                        <div  v-else style="float: left;margin-right: 15px;">
                            ...
                            <p>{{this.mainBusi.twoEntryName+'  '||'通知人'}}</p>
                        </div>
                    </Col>
                </Row>
            </div>
...
export default {
  ...
  methods: {
    ...
    removeReverseLabel (index) {
      ...
      this.mainBusi.getSecondTagReverse.splice(index, 1)
    },
    // 按钮操作返回
    goBack () {
